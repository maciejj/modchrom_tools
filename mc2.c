...
int    eneoutfreq;      // how often should we save ebnergy
...
//Assigning values to global variables defined before functions
	num_threads=4; //MJ was 8
	check=0;
	...
	rfac=0.879;
	cgbeadsize=5.0; double rise=0.340;
	...
	initkT=0.59*500;  // initial temperature
	...
	anglek=0.05;         // force constant for angle restraint
	...
	eneoutfreq=2500;      // how often should we save ebnergy

	cutofflen;

	regenlookupfreq=100; // how often should we regenerate entire lookup table
